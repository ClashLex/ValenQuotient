      ...
      <div className="relative w-full z-20 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="font-mono text-[10px] uppercase tracking-wide leading-relaxed text-[#9cb4e5]/80 mt-2 max-w-md">
            We coordinate real-time carbon calculations with Gold Standard offsetting protocols,
            reducing personal footprints to reality parity.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="grid grid-cols-2 gap-3 lg:hidden">
              {[
                ...
                <div key={i} className="liquid-glass rounded-xl p-3 border border-white/5">
                  <span className="font-mono text-[8px] text-[#9cb4e5]/60 uppercase block">
                    {stat.label}
                  </span>
          ...
          <div className="liquid-glass rounded-2xl border border-white/5 bg-[#010828]/50 p-4 sm:p-5">
            <div className="mb-4">
              ...
              <span className="font-grotesk text-base text-cream tracking-wider uppercase">
                EFFICACY NAVIGATION FAQ
              </span>
            </div>
