    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center pt-7 pb-4 px-6">
          ...
          <h2 className="font-grotesk text-base text-cream uppercase tracking-widest">VALENQUOTIENT</h2>
          <div className="flex items-center gap-1.5 mt-1">
            <Leaf size={8} className="text-neon" />
            <span className="font-mono text-[8px] text-neon/60 uppercase tracking-widest">Save your progress across devices</span>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="font-mono text-[9px] text-cream/30 uppercase tracking-widest">or email</span>
            <div className="flex-1 h-px bg-white/8" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
            {mode === 'signup' && (
              <div className="relative">
                <User size={13} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-cream/30 pointer-events-none" />
                <input
                  id="auth-name"
                  type="text"
            ...
            <div className="relative">
              <Mail size={13} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-cream/30 pointer-events-none" />
              <input
                id="auth-email"
                type="email"
            ...
            <div className="relative">
              <Lock size={13} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-cream/30 pointer-events-none" />
              <input
                id="auth-password"
